...
MyFrame::MyFrame()
    : wxFrame(nullptr, wxID_ANY, _("ztc wxMathPlot mp1 version"), wxDefaultPosition, wxSize(800, 600))
{
    Maximize();
    ...
    m_plot = new mpWindow(this, -1, wxPoint(0, 0), wxSize(800, 600), wxSUNKEN_BORDER);
