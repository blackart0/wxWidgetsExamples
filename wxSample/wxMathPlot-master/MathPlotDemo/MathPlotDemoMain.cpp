...
MathPlotDemoFrame::MathPlotDemoFrame(wxWindow* parent,wxWindowID id)
{
    ...
    pLog = new wxPanel(this, ID_PANEL1, wxDefaultPosition, wxSize(134,381), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
    ...
    AuiManager1->AddPane(pLog, wxAuiPaneInfo().Name(_T("PaneName0")).DefaultPane().Caption(_("Log")).CaptionVisible().CloseButton(false).Left().Floatable(false).BestSize(wxSize(134,381)).MinSize(wxSize(120,-1)).Movable(false));
    pPlot = new wxPanel(this, ID_PANEL2, wxPoint(227,228), wxDefaultSize, wxTAB_TRAVERSAL, _T("ID_PANEL2"));
    BoxSizer1 = new wxBoxSizer(wxVERTICAL);
    mPlot = new mpWindow(pPlot, ID_MATHPLOT1, wxDefaultPosition, wxSize(639,371), wxTAB_TRAVERSAL);
    mPlot->UpdateAll();
    mPlot->Fit();
